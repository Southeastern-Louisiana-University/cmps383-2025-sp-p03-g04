...
namespace Selu383.SP25.P03.Api.Data
{
    public static class SeedMovies
    {
        public static void Initialize(IServiceProvider serviceProvider)
        {
            ...
            {
                // Add each movie if it doesn't exist
                if (!context.Movies.Any(x => x.Title == "Disney's Snow White" ))
                {
                    context.Movies.Add(
                        new Movie{
                    ...
                    context.Movies.Add(
                        new Movie{
                            ...
                            Description = "MAGAZINE DREAMS follows aspiring bodybuilder Killian Maddox, who looks after his ailing grandfather while pursuing his dreams and struggling to find human connection. Maddox's obsession with being the best and one day gracing the cover of a magazine like his hero Brad Vanderhorn (O'Hearn) ultimately leads to a downward spiral as his rage grows and his grip starts to slip. The film is an examination of celebrity, violence and the American Dream told through the lens of one man's relentless pursuit of admiration and respect.",
                    ...
                    context.Movies.Add(
                        new Movie{
                            ...
                            Description = "BOB TREVINO LIKES IT is inspired by the true friendship that writer/director Tracie Laymon found with a stranger in real life while looking for her father online. Often playing the role of caretaker to people like her father, who should be caring for her, Lily Trevino longs for familial connection. When her father, Robert, finally checks out of her life, Lily looks for him on the internet.",
