...
const PaymentPage: React.FC = () => {
  ...
  // Check if cart is empty and redirect if necessary (but NOT when processing payment)
  useEffect(() => {
  ...
  // // Handle guest checkout using the existing GuestSessionsController
  ...
  //       },
  //       body: JSON.stringify({ /* empty body as per controller */ })
  //     });
 ...
 // Update your handleSubmit function to bypass seat reservation errors:
            ...
            <div className="tickets-summary">
              ...
              <div className="tickets-list">
                {cartItems.map((item: CartItem) => (
                  <div key={item.seatId} className="ticket-item">
