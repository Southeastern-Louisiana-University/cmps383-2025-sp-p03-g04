const styles = StyleSheet.create({
  ...
  export default function FoodPaymentScreen() {
    ...
    const [deliveryType, setDeliveryType] = useState<"Pickup" | "ToSeat">("Pickup");
    ...
    useEffect(() => {
      const loadCartData = async () => {
        ...
        try {
          ...
          Alert.alert("Error", "Could not load your order details. Please try again.");
        } finally {
          setIsLoading(false);
        }
      };
    ...
    // Process payment and create food order
    const handlePayment = async () => {
      ...
      try {
        ...
        // For authenticated users, create a real order in the backend
        if (isAuthenticated && user) {
          ...
          // For guest users, simulate successful order
          // Store order in AsyncStorage for guest history
          ...
          await AsyncStorage.setItem("guestFoodOrders", JSON.stringify(guestOrders));
            ...
            <View style={styles.summaryContainer}>
              ...
              <View style={styles.deliveryInfo}>
                ...
                <ThemedText style={styles.deliveryValue}>
                  {deliveryType === "ToSeat" ? "To your seat" : "Pickup at counter"}
                </ThemedText>
              </View>
