...
export default function Index() {
  ...
  const handleClearAuthStorage = async () => {
    try {
      ...
      Alert.alert(
        "Storage Cleared",
        "Auth storage has been cleared. App will restart."
      );
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity activeOpacity={0.8} onPress={handleTitlePress}>
      ...
      {DEVELOPMENT_MODE && showDevButtons && (
        <View style={styles.devButtonsContainer}>
          ...
          <TouchableOpacity style={styles.devButton} onPress={handleLogStorage}>
