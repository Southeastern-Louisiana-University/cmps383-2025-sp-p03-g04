...
import { StyleSheet, ScrollView, RefreshControl, TouchableOpacity, View, ActivityIndicator } from 'react-native';
    ...
    return (
      <ThemedView style={styles.container}>
        <View style={styles.staffHeader}>
          ...
          <ThemedText style={styles.staffSubtitle}>Welcome back, {user.username}</ThemedText>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.staffContent}>
          ...
          <View style={styles.statCard}>
            ...
            <View style={styles.statInfo}>
              ...
              <ThemedText style={styles.statLabel}>Today's Attendance</ThemedText>
            </View>
            <TouchableOpacity 
              style={styles.actionButton}
          ...
          <View style={styles.quickActionsContainer}>
            ...
            <View style={styles.quickActions}>
              ...
              >
                ...
                <ThemedText style={styles.quickActionText}>Scan Tickets</ThemedText>
              </TouchableOpacity>
              ...
              >
                ...
                <ThemedText style={styles.quickActionText}>Deliver Orders</ThemedText>
              </TouchableOpacity>
              ...
              >
                ...
                <ThemedText style={styles.quickActionText}>Validate Tickets</ThemedText>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
    ...
    return (
      <ThemedView style={styles.container}>
        <View style={styles.managerHeader}>
          ...
          <ThemedText style={styles.managerSubtitle}>Welcome back, {user.username}</ThemedText>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.managerContent}>
          <View style={styles.overviewRow}>
            <View style={[styles.overviewCard, styles.salesCard]}>
              ...
              <ThemedText style={styles.overviewLabel}>Today's Sales</ThemedText>
          ...
          <View style={styles.performanceContainer}>
            <View style={styles.sectionHeaderRow}>
              <ThemedText style={styles.sectionTitle}>Top Performing Movies</ThemedText>
            ...
            >
              {movies.slice(0, 5).map((movie, index) => (
                <View key={movie.id} style={styles.performanceCard}>
                  ...
                  <ThemedText style={styles.movieMetric}>{80 - index * 12}% capacity</ThemedText>
                </View>
              ))}
            </ScrollView>
          </View>
          ...
          <View style={styles.actionsContainer}>
            ...
            >
              ...
              <View style={styles.actionTextContainer}>
                <ThemedText style={styles.actionTitle}>Schedule Management</ThemedText>
                <ThemedText style={styles.actionDescription}>Manage movie showtimes and staff assignments</ThemedText>
              </View>
            ...
            >
              ...
              <View style={styles.actionTextContainer}>
                <ThemedText style={styles.actionTitle}>Concession Inventory</ThemedText>
                <ThemedText style={styles.actionDescription}>Manage food items and inventory levels</ThemedText>
              </View>
              <Ionicons name="chevron-forward" size={24} color="#666666" />
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.actionTextContainer}>
                <ThemedText style={styles.actionTitle}>Staff Management</ThemedText>
                <ThemedText style={styles.actionDescription}>Manage staff accounts and permissions</ThemedText>
              </View>
              <Ionicons name="chevron-forward" size={24} color="#666666" />
            </TouchableOpacity>
          </View>
