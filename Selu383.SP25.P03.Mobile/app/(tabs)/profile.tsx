          ...
          <>
            <View style={styles.settingRow}>
              <View style={styles.settingLabelContainer}>
                <Ionicons name="notifications-outline" size={22} color="#B4D335" />
            ...
            <View style={styles.settingRow}>
              <View style={styles.settingLabelContainer}>
                ...
                <ThemedText style={styles.settingLabel}>Theater Mode</ThemedText>
              </View>
              <Switch
                value={theaterMode}
    ...
    <ThemedView style={styles.container}>
      <View style={[styles.header, { backgroundColor: getHeaderColor() }]}>
        ...
        <ThemedText style={styles.roleText}>
          {user?.role === 'customer' ? 'Customer' : user?.role === 'staff' ? 'Staff Member' : 'Manager'}
        </ThemedText>
      </View>
      ...
      <ScrollView style={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            <View style={styles.settingLabelContainer}>
              <Ionicons name="moon-outline" size={22} color={getHeaderColor()} />
